...
while True:
    ...
    if response == "left":
        ...
        if castle == "left":
            webbrowser.open('https://ew.com/thmb/urBvdw0C2Z5emO7FFzHAF1_4pjU=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/the-hulk-2000-718378f1f36d4404a42d1eea9d65f350.jpg')
